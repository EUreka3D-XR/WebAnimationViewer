import { j as SceneComponentConstants, p as Tools, T as Texture, C as Constants, O as Observable, E as EngineStore, a7 as DrawWrapper, G as VertexBuffer, w as RenderTargetTexture, M as Material, _ as __decorate, s as serialize, e as RegisterClass, x as Vector4, L as Logger, g as Engine, a as PostProcess, a8 as _RetryWithInterval, V as Vector3, i as _WarnImport } from './index-PgAdAgf8.esm.js';
            ...
            this._drawWrapper.effect = engine.createEffect(shaders, [VertexBuffer.PositionKind], this._uniforms, this._samplers, defines, undefined, undefined, () => {
                ...
                if (this._options.extraInitializationsAsync) {
                    if (this.shaderLanguage === 1 /* ShaderLanguage.WGSL */) {
                        await Promise.all([import('./procedural.vertex-t32JUrAj.esm.js'), this._options.extraInitializationsAsync()]);
                    }
                    else {
                        await Promise.all([import('./procedural.vertex-DvTM0-hj.esm.js'), this._options.extraInitializationsAsync()]);
                    }
                }
                else {
                    if (this.shaderLanguage === 1 /* ShaderLanguage.WGSL */) {
                        await import('./procedural.vertex-t32JUrAj.esm.js');
                    }
                    else {
                        await import('./procedural.vertex-DvTM0-hj.esm.js');
                    }
                }
            });
        }
    ...
    _createTextures() {
        ...
        const cdfOptions = {
            ...
            extraInitializationsAsync: async () => {
                if (isWebGPU) {
                    await Promise.all([import('./iblCdfx.fragment-DBM3djPs.esm.js'), import('./iblCdfy.fragment-DOfccNFe.esm.js'), import('./iblScaledLuminance.fragment-BUwRFVhs.esm.js')]);
                }
                else {
                    await Promise.all([import('./iblCdfx.fragment-B1zUwy-j.esm.js'), import('./iblCdfy.fragment-DL-o4ghX.esm.js'), import('./iblScaledLuminance.fragment-CVp8ZGdG.esm.js')]);
                }
            },
        };
        const icdfOptions = {
            ...
            extraInitializationsAsync: async () => {
                if (isWebGPU) {
                    await Promise.all([import('./iblIcdf.fragment-Cibo1Z80.esm.js'), import('./iblDominantDirection.fragment-CsOQfvI7.esm.js')]);
                }
                else {
                    await Promise.all([import('./iblIcdf.fragment-BDC07yfD.esm.js'), import('./iblDominantDirection.fragment-KFEYoF4m.esm.js')]);
                }
            },
        };
    ...
    _createDebugPass() {
        ...
        const debugOptions = {
            ...
            extraInitializations: (useWebGPU, list) => {
                if (useWebGPU) {
                    list.push(import('./iblCdfDebug.fragment-DG-V_rgI.esm.js'));
                }
                else {
                    list.push(import('./iblCdfDebug.fragment-PpnoQwRH.esm.js'));
                }
            },
        };
