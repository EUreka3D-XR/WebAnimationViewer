import { C as Constants, m as ILog2, V as Vector3, f as EffectWrapper, n as EffectRenderer, B as BaseTexture, o as Matrix, O as Observable, T as Texture, p as Tools, q as CubeMapToSphericalPolynomialTools, r as ToGammaSpace, t as ToHalfFloat, e as RegisterClass } from './index-PgAdAgf8.esm.js';
import { I as IblCdfGenerator } from './iblCdfGenerator-MM_ZMInZ.esm.js';
import { G as GetCubeMapTextureData } from './hdr-BuWMD53V.esm.js';
    ...
    _createEffect(texture, onCompiled) {
        ...
        const effectWrapper = new EffectWrapper({
            ...
            extraInitializationsAsync: async () => {
                if (isWebGPU) {
                    await Promise.all([import('./hdrFiltering.vertex-Dektrbir.esm.js'), import('./hdrFiltering.fragment-C6nRUKUY.esm.js')]);
                }
                else {
                    await Promise.all([import('./hdrFiltering.vertex-CSlRA7Iu.esm.js'), import('./hdrFiltering.fragment-DOD5lRs2.esm.js')]);
                }
            },
        });
...
class HDRIrradianceFiltering {
    ...
    _createEffect(texture, onCompiled) {
        ...
        const effectWrapper = new EffectWrapper({
            ...
            extraInitializationsAsync: async () => {
                if (isWebGPU) {
                    await Promise.all([import('./hdrIrradianceFiltering.vertex-ByilmD5y.esm.js'), import('./hdrIrradianceFiltering.fragment-BAtx9oJE.esm.js')]);
                }
                else {
                    await Promise.all([import('./hdrIrradianceFiltering.vertex-B9RHxeMC.esm.js'), import('./hdrIrradianceFiltering.fragment-p16aloLh.esm.js')]);
                }
            },
        });
        return effectWrapper;
...
//# sourceMappingURL=hdrCubeTexture-BCXkREJm.esm.js.map
