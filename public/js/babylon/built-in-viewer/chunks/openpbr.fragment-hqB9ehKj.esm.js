...
import './oitFragment-Dt8pKIxY.esm.js';
import './openpbrUboDeclaration-B7JZpu4W.esm.js';
import './pbrDebug-DdBymsat.esm.js';
import './shadowsFragmentFunctions-0IyCajME.esm.js';
import './samplerFragmentDeclaration-_Mn3QY3U.esm.js';
import './imageProcessingFunctions-DMhJjsRy.esm.js';
import './clipPlaneFragment-DEZpWZmM.esm.js';
import './logDepthDeclaration-D8K9Je9E.esm.js';
import './fogFragment-CsbmPAr2.esm.js';
import './helperFunctions-DXCCFY6B.esm.js';
import './hdrFilteringFunctions-CCH7AE0k.esm.js';
import './harmonicsFunctions-DFtfASEm.esm.js';
import './pbrBRDFFunctions-DzIeypMA.esm.js';
import './sceneUboDeclaration-CCfrn0sQ.esm.js';
import './meshUboDeclaration-fvrf8Ipf.esm.js';
import './mainUVVaryingDeclaration-Bu5Cys3l.esm.js';

// Do not edit.
const name$g = "openpbrFragmentSamplersDeclaration";
const shader$g = `#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
// Do not edit.
const name$f = "openpbrNormalMapFragmentMainFunctions";
const shader$f = `#if defined(GEOMETRY_NORMAL) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
// Do not edit.
const name$e = "openpbrNormalMapFragmentFunctions";
const shader$e = `#if defined(GEOMETRY_NORMAL)
...
// Do not edit.
const name$d = "openpbrDielectricReflectance";
const shader$d = `struct ReflectanceParams
{F0: f32,
F90: f32,
coloredF0: vec3f,
coloredF90: vec3f,};
...
// Do not edit.
const name$c = "openpbrConductorReflectance";
const shader$c = `#define pbr_inline
...
// Do not edit.
const name$b = "openpbrBlockAmbientOcclusion";
const shader$b = `struct ambientOcclusionOutParams
...
// Do not edit.
const name$a = "openpbrGeometryInfo";
const shader$a = `struct geometryInfoOutParams
{NdotV: f32,
NdotVUnclamped: f32,
...
// Do not edit.
const name$9 = "openpbrIblFunctions";
const shader$9 = `#ifdef REFLECTION
fn sampleIrradiance(
surfaceNormal: vec3f
...
// Do not edit.
const name$8 = "openpbrNormalMapFragment";
const shader$8 = `var uvOffset: vec2f= vec2f(0.0,0.0);
...
// Do not edit.
const name$7 = "openpbrBlockNormalFinal";
const shader$7 = `#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
// Do not edit.
const name$6 = "openpbrBaseLayerData";
const shader$6 = `var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);
#ifdef BASE_WEIGHT
...
// Do not edit.
const name$5 = "openpbrCoatLayerData";
const shader$5 = `var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
// Do not edit.
const name$4 = "openpbrThinFilmLayerData";
const shader$4 = `#ifdef THIN_FILM
...
//# sourceMappingURL=openpbr.fragment-hqB9ehKj.esm.js.map
