import { L as Logger, aF as SphericalPolynomial, V as Vector3, C as Constants, l as InternalTexture, B as BaseTexture, p as Tools, m as ILog2, a as PostProcess } from './index-PgAdAgf8.esm.js';
...
async function _UploadLevelsAsync(texture, imageData, canGenerateNonLODTextures, imageType = DefaultEnvironmentTextureImageType) {
    ...
    if (expandTexture) {
        if (engine.isWebGPU) {
            ...
            await import('./rgbdDecode.fragment-D9EbFkH7.esm.js');
        }
        else {
            await import('./rgbdDecode.fragment-DC-AhtGC.esm.js');
        }
...
//# sourceMappingURL=environmentTextureTools-Dgu-BT86.esm.js.map
