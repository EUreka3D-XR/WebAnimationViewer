import { p as Tools, bx as KeyboardEventTypes, V as Vector3, _ as __decorate, s as serialize, by as CameraInputTypes, O as Observable, bz as PointerEventTypes, bA as EventConstants, o as Matrix, bB as CameraInputsManager, bC as TargetCamera, ab as AbstractEngine, d as Vector2, aL as serializeAsVector3, e as RegisterClass, E as EngineStore, S as SerializationHelper, aK as GetClass, G as VertexBuffer, T as Texture, C as Constants, aX as SmartArray, L as Logger, bD as Decode, bE as GLTFFileLoaderMetadata, bF as GLTFMagicBase64Encoded, bG as DecodeBase64UrlToBinary, bH as RuntimeError, bI as ErrorCodes, aI as RegisterSceneLoaderPlugin, bJ as registerGLTFExtension, bK as unregisterGLTFExtension, M as Material, bL as registeredGLTFExtensions, v as Mesh, aq as AbstractMesh, br as TransformNode, bM as deepMerge, bN as Geometry, Q as Quaternion, b as Camera, bO as Lazy, am as Buffer, aW as Color3, bP as Deferred, bQ as GetMimeType, bR as IsBase64DataUrl, bS as LoadFileError, bT as GetTypedArrayConstructor, c as TmpVectors, bU as BoundingInfo } from './index-PgAdAgf8.esm.js';
import { B as Bone } from './bone-BoyFz1Xg.esm.js';
import { S as Skeleton } from './skeleton-DmAdgmh_.esm.js';
import { A as AssetContainer } from './assetContainer-DTFyVy0_.esm.js';
import { G as GetMappingForKey } from './objectModelMapping-CD1oJl7L.esm.js';
...
const LazyAnimationGroupModulePromise = new Lazy(() => import('./animationGroup-ciTxLmQo.esm.js'));
const LazyLoaderAnimationModulePromise = new Lazy(() => import('./glTFLoaderAnimation-CiIsCqK-.esm.js'));
/**
            ...
            if (!this.parent.skipMaterials && this._pbrMaterialImpl == null) {
                if (this.parent.useOpenPBR || this.isExtensionUsed("KHR_materials_openpbr")) {
                    this._pbrMaterialImpl = {
                        materialClass: (await import('./openPbrMaterial-CC89Te4d.esm.js')).OpenPBRMaterial,
                        adapterClass: (await import('./openPbrMaterialLoadingAdapter-CCdbhdFw.esm.js')).OpenPBRMaterialLoadingAdapter,
                    };
                }
                else {
                    this._pbrMaterialImpl = {
                        materialClass: (await import('./index-PgAdAgf8.esm.js').then(function (n) { return n.cv; })).PBRMaterial,
                        adapterClass: (await import('./pbrMaterialLoadingAdapter-CtnSnrCk.esm.js')).PBRMaterialLoadingAdapter,
                    };
                }
            }
...
//# sourceMappingURL=glTFLoader-CKeTMOdS.esm.js.map
