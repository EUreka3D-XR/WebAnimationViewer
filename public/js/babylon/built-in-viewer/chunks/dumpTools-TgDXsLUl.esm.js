import { c4 as Clamp, C as Constants, p as Tools, E as EngineStore, L as Logger, n as EffectRenderer, f as EffectWrapper } from './index-PgAdAgf8.esm.js';
...
async function _CreateDumpResourcesAsync() {
    ...
    const { ThinEngine: thinEngineClass } = await import('./index-PgAdAgf8.esm.js').then(function (n) { return n.cu; });
    ...
    const { passPixelShader } = await import('./pass.fragment-CE9DfTC5.esm.js');
...
//# sourceMappingURL=dumpTools-TgDXsLUl.esm.js.map
