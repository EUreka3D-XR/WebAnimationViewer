import { C as Constants, E as EngineStore, L as Logger, P as PassPostProcess, T as Texture, a as PostProcess, V as Vector3, b as Camera, c as TmpVectors, d as Vector2, R as RandomRange, S as SerializationHelper, _ as __decorate, s as serialize, e as RegisterClass } from './index-PgAdAgf8.esm.js';
import { P as PostProcessRenderPipeline, a as PostProcessRenderEffect } from './postProcessRenderEffect-BdKhAR29.esm.js';
import { G as GeometryBufferRenderer } from './geometryBufferRenderer-Cbq89n5o.esm.js';
import { R as RawTexture } from './rawTexture-C1LxPWXb.esm.js';
import './postProcessRenderPipelineManagerSceneComponent-JyxvvqwL.esm.js';
...
class SSAO2RenderingPipeline extends PostProcessRenderPipeline {
    ...
    _createBlurFilter(name, samplers, ratio, defines, textureType, horizontal) {
        const blurFilter = new PostProcess(name, "ssao2", ["outSize", "samples", "soften", "tolerance"], samplers, ratio, null, Texture.BILINEAR_SAMPLINGMODE, this._scene.getEngine(), false, defines, textureType, undefined, undefined, undefined, undefined, this._scene.getEngine().isWebGPU ? 1 /* ShaderLanguage.WGSL */ : 0 /* ShaderLanguage.GLSL */, (useWebGPU, list) => {
            if (useWebGPU) {
                list.push(import('./ssao2.fragment-CoOdPydf.esm.js'));
            }
            else {
                list.push(import('./ssao2.fragment-CZjk-hqi.esm.js'));
            }
        });
    ...
    _createSSAOCombinePostProcess(ratio, textureType) {
        this._ssaoCombinePostProcess = new PostProcess("ssaoCombine", "ssaoCombine", [], ["originalColor", "viewport"], ratio, null, Texture.BILINEAR_SAMPLINGMODE, this._scene.getEngine(), false, undefined, textureType, undefined, undefined, undefined, undefined, this._scene.getEngine().isWebGPU ? 1 /* ShaderLanguage.WGSL */ : 0 /* ShaderLanguage.GLSL */, (useWebGPU, list) => {
            if (useWebGPU) {
                list.push(import('./ssaoCombine.fragment-DH3TswQO.esm.js'));
            }
            else {
                list.push(import('./ssaoCombine.fragment-DJpx_wGq.esm.js'));
            }
        });
...
//# sourceMappingURL=ssao2RenderingPipeline-BRyZsAWP.esm.js.map
