...
import './oitFragment-CY_-IwHz.esm.js';
import './openpbrUboDeclaration-DSbUfxSR.esm.js';
import './pbrDebug-DU8nVBfr.esm.js';
import './shadowsFragmentFunctions-BRyppND_.esm.js';
import './bumpFragment-CTn3Oogh.esm.js';
import './imageProcessingFunctions-Gu4Ij7sv.esm.js';
import './logDepthDeclaration-CTEbXhzO.esm.js';
import './fogFragment-DRvFoQOh.esm.js';
import './helperFunctions-BwqynSvG.esm.js';
import './hdrFilteringFunctions-CeqhRnv3.esm.js';
import './harmonicsFunctions-CkbojQoT.esm.js';
import './pbrBRDFFunctions-DxVnda8_.esm.js';
import './sceneUboDeclaration-BrCYfMie.esm.js';
import './meshUboDeclaration-BpdEpQXk.esm.js';
import './mainUVVaryingDeclaration-D0_SyMbg.esm.js';

// Do not edit.
const name$h = "openpbrFragmentDeclaration";
...
const shader$f = `#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(DETAIL)
...
const shader$8 = `vec2 uvOffset=vec2(0.0,0.0);
...
const shader$6 = `vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);
#ifdef BASE_WEIGHT
...
const shader$5 = `float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
//# sourceMappingURL=openpbr.fragment-EJbCoQuq.esm.js.map
